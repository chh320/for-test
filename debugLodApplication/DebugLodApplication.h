...
namespace Vk {
    ...
    public:
        ...
        void RecordCommand(std::vector<uint32_t>& packedData, uint32_t meshNum);
        void CreateSyncObjects();
        void Run(std::vector<uint32_t>& packedData, uint32_t meshNum);
        ...
        void Draw(VkCommandBuffer cmd, uint32_t instanceNum);
